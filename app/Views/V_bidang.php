                        ...
                        foreach ($data_bidang as $d) { ?>
                            <tr>
                                ...
                                <td class="text-center" width="100px">
                                    <a class="btn btn-sm btn-success" href="javascript:void(0)" onclick="edit( '<?= $d->id_bidang ?>',
                                                                                '<?= $d->nama_bidang ?>', 
                                                                               )">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-sm btn-danger" href="javascript:void(0)" onclick="hapus('<?= $d->id_bidang ?>','<?= $d->nama_bidang ?>')">
...
<div class="modal fade" id="modal_add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" action="<?php echo site_url('C_admin/save_bidang') ?>">
...
<div class="modal fade" id="edit_data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" action="<?php echo site_url('C_admin/edit_bidang') ?>">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Bidang</label>
...
<div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo site_url('C_admin/delete_bidang') ?>">
                <div class="modal-body">
