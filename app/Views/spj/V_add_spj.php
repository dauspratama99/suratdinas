...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form method="POST" name="form_rental" action="<?= site_url('C_spj/save_spj') ?>">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="hidden" id="id_npd" readonly name="id_npd" class="form-control">
                                <input type="hidden" id="id_kegiatan" readonly name="id_kegiatan" class="form-control">
                                <input type="hidden" readonly id="id_pegawai" name="id_pegawai" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" id="nominal" name="nominal" readonly class="form-control" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="pptk" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="disetujui" class="form-control" required>
                            </div>
                        </div>
                    </div>
